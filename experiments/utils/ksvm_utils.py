# from this file: https://github.com/chens5/WL-distance/blob/2b5950c2cccdb773fa5902142d92b36b5013485d/experiments/ksvm_utils.py
# itself from this file: https://github.com/BorgwardtLab/WTK/blob/master/src/wtk/utilities.py
...
class KreinSVC(BaseEstimator, ClassifierMixin):
    ...
    '''
    def __init__(self, C=1.0, kernel='precomputed', degree=3, gamma='scale',
